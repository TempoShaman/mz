...
df = pd.read_csv("tweets.csv", parse_dates= [6])
...
abel = kmeans.fit_predict(nmf)

u_labels = np.unique(abel)

#plotting the results:

for i in u_labels:
    plt.scatter(nmf[abel == i , 0] , nmf[abel == i , 1] , label = i)
plt.legend()
plt.show()